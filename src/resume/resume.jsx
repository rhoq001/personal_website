...
const RESUME = {
    ...
    [
      ...
      },
      {
        ...
        timeline_type: 'cert',
        id: 'JS',
        name: 'Javascript Data Structures and Algorithms/ Front-end Libraries Certifications',
        dates: 'Sep. 2022 - May 2022',
        description: [
    ...
    [
      ...
      },
      {
        id: 'quote',
        name: 'Quote Machine',
        github: "https://github.com/rhoq001/quote-machine",
        demo: 'https://rhoq001.github.io/quote-machine/',
        img: IMG9,
        about: [
          {id: 'time a1', str: 'Basic Web Application for an HTML Mock Markup converter'},
          {id: 'time a2', str: 'Developed using ReactJS, HTML5, and Bootstrap CSS'},
          {id: 'time a3', str: 'Hosted on Github Pages'},
          {id: 'time a4', str: 'Uses react-bootstrap library for components'},
          {id: 'time a5', str: 'generates new quotes on button press'},
        ],
        how_works: `Pressing the quote button will generate a new quote and display it in the quote box. Pressing the tweet button will allow you to tweet it.`,
        problems_learned: [
          {id: 'time p1', str: 'This project was an introductory project to Bootstrap CSS.'},
          {id: 'time p2', str: 'I learned the majority of bootstrap by playing around with this project.'},
        ]
      },
      {
        id: 'shadowman',
